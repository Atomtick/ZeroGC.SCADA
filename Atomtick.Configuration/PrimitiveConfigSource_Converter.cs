...
namespace Atomtick.Configuration
{
    public partial class PrimitiveConfigSource : IConfigConverter
    {
        ...
        private const long _longMax = 9007199254740992;
        private const long _longMin = -9007199254740992;
        ...
        public object Convert2Object(ConfigType type, string value)
        {
            switch (type)
            {
                ...
                case ConfigType.Integer:
                    TryParse2Int64(value, out long @long);
                    return @long;

                case ConfigType.Decimal:
                    TryParse2Double(value, out double @double);
                    return @double;
                ...
                case ConfigType.File:
                    TryParse2File(value, out var file);
                    return file;

                case ConfigType.Folder:
                    TryParse2Directory(value, out var folder);
                    return folder;

                case ConfigType.Color:
                    TryParse2Color(value, out var color);
                    return color;

                case ConfigType.DateTime:
                    TryParse2DateTime(value, out var dateTime);
                    return dateTime;
